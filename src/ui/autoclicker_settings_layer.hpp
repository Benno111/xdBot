...
class AutoclickerLayer : public xdb::Popup<>, public TextInputDelegate {
...
private:
	...
	void updateInputs() {
		...
		holdInput->getInputNode()->setLabelPlaceholderColor(g.autoclickerP1 ? ccc3(163, 135, 121) : ccc3(100, 100, 100));
		if (!g.autoclickerP1) {
		...
		holdInput2->getInputNode()->setLabelPlaceholderColor(g.autoclickerP2 ? ccc3(163, 135, 121) : ccc3(100, 100, 100));
		if (!g.autoclickerP2) {
		...
		releaseInput->getInputNode()->setLabelPlaceholderColor(g.autoclickerP1 ? ccc3(163, 135, 121) : ccc3(100, 100, 100));
		if (!g.autoclickerP1) {
		...
		releaseInput2->getInputNode()->setLabelPlaceholderColor(g.autoclickerP2 ? ccc3(163, 135, 121) : ccc3(100, 100, 100));
		if (!g.autoclickerP2) {
